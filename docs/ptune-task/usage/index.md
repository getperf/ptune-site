...
まずはこちらのページで、Obsidian と ptune を連携した  
**1日の流れ（5つのステップ）** を確認してください。

→ [1日の流れ（全体像）を見る](overview-daily-flow.md)

次に、各ステップをチュートリアル形式で説明します。  

→ [① 朝：タスク定義](step1_morning-task-entry.md)  
→ [② 昼：作業開始](step2_start-working.md)  
→ [③ 作業記録](step3_note-taking.md)  
→ [④ 作業終了](step4_wrap-up.md)  
→ [⑤ 夜：振り返り](step5_night-review.md)